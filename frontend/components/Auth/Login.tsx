            ...
            <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 w-full h-full">
                    ...
                    <div className="lg:col-span-2 min-h-screen hidden lg:block relative">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-br from-white/60 via-blue-100/40 
                                to-yellow-100/40 rounded-r-3xl"></div>
                    </div>
                    {/* بطاقة تسجيل الدخول */}
                    <div className="lg:col-span-3 flex flex-col items-center justify-center min-h-screen p-4 bg-transparent">
                        <div className="w-full max-w-md p-6 sm:p-8 bg-white/90 border border-blue-100 
                            ...
                            <form onSubmit={handleSubmit} className="block w-full space-y-5">
                                ...
                                <div>
                                    ...
                                    <Link href="/auth/forget-password"
                                     className="text-sm text-blue-500 hover:text-blue-400 mt-2 block
                                      cursor-pointer font-medium text-right transition-colors">
                                        Forgot Password?
                                    </Link>
                                </div>
                                {/* زر الدخول */}
                                <LoadingButton
                                    size={"lg"}
                                    className="w-full mt-4 rounded-lg shadow-lg bg-blue-500 text-white
                                     font-bold hover:bg-blue-600 transition-all duration-300"
                                    type="submit"
                                    isLoading={isLoading}
                                >
                                    Log In
                        ...
                        <h1 className="mt-8 text-base text-gray-600 text-center">
                            ...
                            <Link href="/auth/signup">
                                ...
                                font-bold transition-colors">Sign Up Here</span>
                            </Link>
                        </h1>
                    </div>
                </div>
