    ...
    <div className="flex flex-col gap-2 w-full px-1 sm:px-2">
            {chats.map((chat) => {
                ...
                return (
                    <div
                        key={chat._id}
                        className={`chat-item-style flex items-center gap-2 sm:gap-3 px-2 py-2
                             rounded-lg cursor-pointer transition-colors duration-150 w-full 
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 w-full">
                            {hasImage ? (
                                ...
                                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center
                                 justify-center bg-primary/20 text-primary font-bold text-base sm:text-lg border">
                                    {avatarText}
                                </div>
                            )}
